...
import { H as H3Event, t as toResponse, g as getRequestHost$1, c as clearSession$1, d as deleteCookie$1, p as parseCookies, a as getRequestIP$1, b as getRequestProtocol$1, e as getRequestURL, f as getSession$1, h as getValidatedQuery$1, s as sealSession$1, i as setCookie$1, j as sanitizeStatusCode, k as sanitizeStatusMessage, u as unsealSession$1, l as updateSession$1, m as useSession$1 } from "../_libs/h3-v2.mjs";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Db5F0ThM.mjs");
...
const manifest = {
  "028bd1610a9773a0a5256e5aee96ebb394a2cbc5778d95eb56042873b882f4e9": {
    functionName: "getEndorsement_createServerFn_handler",
    importer: () => import("./policies.functions-Bv-8TrxN.mjs")
  },
  "02c3d98da6d80297359f488e59a79764e3d341df6491900d2df0b54828e1ec2c": {
    functionName: "getPolicySyncStatus_createServerFn_handler",
    importer: () => import("./policies.functions-Bv-8TrxN.mjs")
  },
  "097ca56136901e7debca9b17b38bbc47d873e47968b5dcccfa2b680fb0efec60": {
    functionName: "getLatestAudit_createServerFn_handler",
    importer: () => import("./audit.functions-Cdb3Trl_.mjs")
  },
  "126b2803b4bb9a9b3bb9fd718879690ed19500f35f4de8154c22171a19a64bee": {
    functionName: "listExceptionReasonTags_createServerFn_handler",
    importer: () => import("./exception-tags.functions-DZMFHAWM.mjs")
  },
  "1adc1e24bae9e0fed111d42b606bc4eb7d4cfcaffb55df4ebb15e7560bf46198": {
    functionName: "getPolicies_createServerFn_handler",
    importer: () => import("./policies.functions-Bv-8TrxN.mjs")
  },
  "253595f411443d4ca128c67aed97d33b1d74a5771d47d7d425490c6944b254da": {
    functionName: "getPolicyBilling_createServerFn_handler",
    importer: () => import("./billing.functions-DnkWgsZc.mjs")
  },
  "2ea295ff8b3cb11662d55154cf637700b4819323f71b14140991795dc052d814": {
    functionName: "addExceptionReasonTag_createServerFn_handler",
    importer: () => import("./exception-tags.functions-DZMFHAWM.mjs")
  },
  "3af6fcdcfa9f296b18086f5d89f2e72bfd34e3b99e4ea078aa9e85515c957363": {
    functionName: "changeOwnPassword_createServerFn_handler",
    importer: () => import("./admin.functions-CWdVh2Kb.mjs")
  },
  "3cf3a8225e68a7cd91e4189257483d894072a472d8d0019b7542475b4926b87d": {
    functionName: "getLatestPolicySync_createServerFn_handler",
    importer: () => import("./policies.functions-Bv-8TrxN.mjs")
  },
  "3df19b731eca75ae30d6d88b184fd9045b8d6f7107fd063e8d21f5d30835df9f": {
    functionName: "listInvites_createServerFn_handler",
    importer: () => import("./admin.functions-CWdVh2Kb.mjs")
  },
  "47075ae2d3122d99ee03f94b96f765166f1086578505d3336fe9e1bf0dd90afc": {
    functionName: "lookupInvite_createServerFn_handler",
    importer: () => import("./invites.functions-Dr1St6zF.mjs")
  },
  "4b6fc12bbf21cd8d645e5e16ad0e6486cd7d7dff98801bbaa1dc95db99a1d753": {
    functionName: "addAuditIgnore_createServerFn_handler",
    importer: () => import("./audit-ignores.functions-C0GADmsW.mjs")
  },
  "4d5438db24682c887085adb79ba4662b976890060e2506e2a2df9fb8dc39b5c9": {
    functionName: "cancelPolicySync_createServerFn_handler",
    importer: () => import("./policies.functions-Bv-8TrxN.mjs")
  },
  "580016288dfebc01a7fcef2adc8a992bda2cf72a0b82855829bc8df91918caf4": {
    functionName: "getCurrentRole_createServerFn_handler",
    importer: () => import("./admin.functions-CWdVh2Kb.mjs")
  },
  ...
  "60ed4426eb98aa4a457185d910927603318966809acf3b55378b9b508ccb3ab4": {
    functionName: "runAudit_createServerFn_handler",
    importer: () => import("./audit.functions-Cdb3Trl_.mjs")
  },
  "6614dac4b16812a4e50d24e80d06ba28d8b61804fdb30ed4fa494bb760fbecb2": {
    functionName: "updateExceptionReasonTag_createServerFn_handler",
    importer: () => import("./exception-tags.functions-DZMFHAWM.mjs")
  },
  "6f41c041a07731785d21b1c81dfac935e9b11e1e0df74adc32b79919b5f663de": {
    functionName: "pingMotorPolicies_createServerFn_handler",
    importer: () => import("./settings.functions-B4N8K-7Z.mjs")
  },
  "729ceb73ec9e2cb220145cd50035031e97b0d4c651f95437dce6f7f2753cf84e": {
    functionName: "unresolveFinding_createServerFn_handler",
    importer: () => import("./audit-resolutions.functions-djn5Uyby.mjs")
  },
  "73049a84442114f6b14215429cf260e46c9744fb212979cf2b1d77276e2577b0": {
    functionName: "exportLatestAuditJSON_createServerFn_handler",
    importer: () => import("./settings.functions-B4N8K-7Z.mjs")
  },
  "77a978f9dfdf7346df5d4f12ca8b02bf43c241d4955d569aca6e9e2897f0c25d": {
    functionName: "getSystemStatus_createServerFn_handler",
    importer: () => import("./audit.functions-Cdb3Trl_.mjs")
  },
  "88edb9b4231b68ed0f9f60d341eb7b966d5c927c58a29cc5cf88410c4b733659": {
    functionName: "listAuditIgnores_createServerFn_handler",
    importer: () => import("./audit-ignores.functions-C0GADmsW.mjs")
  },
  "8972cba1e7bd86457ab4fe2a35382b627bf9047c26a8a14e3ffda4c8036c4539": {
    functionName: "getExtractionHistory_createServerFn_handler",
    importer: () => import("./endorsement-extraction.functions-D7APum4p.mjs")
  },
  "8d1f79275fdf5502f58ef20472ac22719103c8a4bf592e74a8c9052e9a9f1968": {
    functionName: "createInvite_createServerFn_handler",
    importer: () => import("./admin.functions-CWdVh2Kb.mjs")
  },
  "9b97897620f38b4ad17635d44b21119a7fc775950bfe58519b6d3487f3d2eb5d": {
    functionName: "getAnalyticsAggregates_createServerFn_handler",
    importer: () => import("./analytics.functions-BsEqg7J2.mjs")
  },
  "9c7194898cebaccaf9ce235253ef0678b83d5c58566f68d149497c78c6a6046e": {
    functionName: "pingAuditWebhook_createServerFn_handler",
    importer: () => import("./settings.functions-B4N8K-7Z.mjs")
  },
  "a0e7b3e2e2d2de9fd51fec8fd9758793248995520c49f064ef6c40d9e3fe4c28": {
    functionName: "updateUser_createServerFn_handler",
    importer: () => import("./admin.functions-CWdVh2Kb.mjs")
  },
  "a6691374db1e6f2781de2c0565132cf29160cb77c2bd743bf6996a2ac72b72a3": {
    functionName: "getAutomationSchedules_createServerFn_handler",
    importer: () => import("./automation.functions-BNw84Ha4.mjs")
  },
  "acb922d13a5ff634c3eab89f3dc86b04f246c73750006e769eebc8106cffa916": {
    functionName: "updateAutomationSchedule_createServerFn_handler",
    importer: () => import("./automation.functions-BNw84Ha4.mjs")
  },
  ...
  "aed61386c5e36442776a0ae2522751e02dcfc7f66ca220d3ac36f26165ec388f": {
    functionName: "getPolicyByNumero_createServerFn_handler",
    importer: () => import("./policies.functions-Bv-8TrxN.mjs")
  },
  "b045d17174f00cbdc7ede0531012d8f28adc5b6e81de952b6de2491814d84db4": {
    functionName: "getOperationKpis_createServerFn_handler",
    importer: () => import("./kpis.functions-C7AQyQN9.mjs")
  },
  "b120782695f5867d4940aff0aee6e539a125c25fd9cca947c516a577fc058f9f": {
    functionName: "removeExceptionReasonTag_createServerFn_handler",
    importer: () => import("./exception-tags.functions-DZMFHAWM.mjs")
  },
  "b29ee520bfee3bf30f61c45a01fd56e527aec9ae9802426cb685d79789aefce3": {
    functionName: "getLatestExtraction_createServerFn_handler",
    importer: () => import("./endorsement-extraction.functions-D7APum4p.mjs")
  },
  "b2ac59cdd580ee1312afa6dcdfa4882829a8fa68d83dbf2a60c9d0061fca096e": {
    functionName: "purgeOldAudits_createServerFn_handler",
    importer: () => import("./settings.functions-B4N8K-7Z.mjs")
  },
  "b5e47136d01b651000c46dba30ebd939155f11ed50994990d028faf809d1d976": {
    functionName: "getBillingIndex_createServerFn_handler",
    importer: () => import("./billing.functions-DnkWgsZc.mjs")
  },
  "c0aad9f33018b8faf6632300a6819e56cab5d97dccf9d8d06ce4d7db41fcaec8": {
    functionName: "getNotifications_createServerFn_handler",
    importer: () => import("./notifications.functions-DiOez5Qq.mjs")
  },
  "c1444affb35ef1659daf20980ad3599f011226becc8d8ef8948b3750257a9b32": {
    functionName: "getResolutionTimeStats_createServerFn_handler",
    importer: () => import("./audit-resolutions.functions-djn5Uyby.mjs")
  },
  "cd65356f1b6bb70a3c5ad26f63deb3b26e87f76ccf4c1f418e2f23ef5fb0a78b": {
    functionName: "consumeInvite_createServerFn_handler",
    importer: () => import("./invites.functions-Dr1St6zF.mjs")
  },
  "cef162a41e5739c71c20de005aabcff667590e7c4e3c5be965d9fcafe2d68666": {
    functionName: "getDataCounters_createServerFn_handler",
    importer: () => import("./settings.functions-B4N8K-7Z.mjs")
  },
  "d24a1a6b7e09d2230a60b2df6c008165f4356d0f35bd1187b69b6f8435c2e078": {
    functionName: "runPolicySync_createServerFn_handler",
    importer: () => import("./policies.functions-Bv-8TrxN.mjs")
  },
  "d2888893047f221536c7c8206a44a09f9c024af4bd03447c28733743d15d38e0": {
    functionName: "listAuditResolutions_createServerFn_handler",
    importer: () => import("./audit-resolutions.functions-djn5Uyby.mjs")
  },
  "d56309e99e6b4e4046c0dc00d9d1cb97f11bb20a62d93df13efae2405f9f3bc0": {
    functionName: "getFindingRecurrence_createServerFn_handler",
    importer: () => import("./audit-recurrence.functions-vEikLPmP.mjs")
  },
  "d63e2fd05520e37a6ae452ef881081244ec0419acd4b8bf6ec095508e97bb8e5": {
    functionName: "updateEndorsementException_createServerFn_handler",
    importer: () => import("./endorsement-extraction.functions-D7APum4p.mjs")
  },
  "d968795a9943bb294c68c9bf481d84d3103d5ea1373825cfedc553251779dfb3": {
    functionName: "createUserManual_createServerFn_handler",
    importer: () => import("./admin.functions-CWdVh2Kb.mjs")
  },
  "d9930ec315ddad261a9c3b58b7cc7bc3e338c351e0252329373a9262415dd71f": {
    functionName: "removeAuditIgnore_createServerFn_handler",
    importer: () => import("./audit-ignores.functions-C0GADmsW.mjs")
  },
  "da34154b13b7c137d141f7e52547e2556db37f5713d1798af26176b7bd79be7c": {
    functionName: "getIntegrationsStatus_createServerFn_handler",
    importer: () => import("./settings.functions-B4N8K-7Z.mjs")
  },
  "dbc7d37a66b1595c39f93132683cfc588ae0649948a6f858cdd972e6a55015c3": {
    functionName: "getExtractionStatus_createServerFn_handler",
    importer: () => import("./endorsement-extraction.functions-D7APum4p.mjs")
  },
  "e2264778fa5dfb8bf66537c89d22e9033378fe42625743f17b08f1848d61bd43": {
    functionName: "getAuditHistory_createServerFn_handler",
    importer: () => import("./audit.functions-Cdb3Trl_.mjs")
  },
  "e7614179fefb75acc6a9a34d09d606c56c0257d637803a9b4316261251223f90": {
    functionName: "getAuditRunStatus_createServerFn_handler",
    importer: () => import("./audit.functions-Cdb3Trl_.mjs")
  },
  "e82b6fe37b10f385029646bddeeb306a2fffa5b04b9bac4ccfe95da82e4c2cbb": {
    functionName: "runEndorsementExtraction_createServerFn_handler",
    importer: () => import("./endorsement-extraction.functions-D7APum4p.mjs")
  },
  "e9598f1c88e2dcdf6e37949cfdbd2526b83410dad0463ceb11739dcd11591dd7": {
    functionName: "removeEndorsementException_createServerFn_handler",
    importer: () => import("./endorsement-extraction.functions-D7APum4p.mjs")
  },
  "eee7ccdfb0d44ee559bce79076fab9edabf91d9dedaef9ed287bef89fc993039": {
    functionName: "listEndorsementExceptions_createServerFn_handler",
    importer: () => import("./endorsement-extraction.functions-D7APum4p.mjs")
  },
  "f48ea7f0ef9a3ccaa7a179c39bbca8514d69a621727a97fe9bd195fe7955f991": {
    functionName: "updateAuditIgnore_createServerFn_handler",
    importer: () => import("./audit-ignores.functions-C0GADmsW.mjs")
  },
  "f4fb64a4ac46c1192657ca4449dd4a8ca48bdcd5546b0d0ebc86369a99ba3d9f": {
    functionName: "resolveFinding_createServerFn_handler",
    importer: () => import("./audit-resolutions.functions-djn5Uyby.mjs")
  },
  "f6e9c4c2e2c4e30fff84427a8a716067a15e6e651a76c96191d4c8424389bbab": {
    functionName: "revokeInvite_createServerFn_handler",
    importer: () => import("./admin.functions-CWdVh2Kb.mjs")
  },
  "fb74ba961b323ca5471afae091ef998985698748aaa8fbc42cbe89644a165236": {
    functionName: "exportPoliciesCSV_createServerFn_handler",
    importer: () => import("./settings.functions-B4N8K-7Z.mjs")
  },
  "fc4d84a2a7e10e4d01d1ca3e57eb76ace01b2e91cdd413cd0ee06af9e55469b7": {
    functionName: "addEndorsementException_createServerFn_handler",
    importer: () => import("./endorsement-extraction.functions-D7APum4p.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-C--tI9WT.mjs").then((n) => n.a2),
    import("./start-Cwadqw_E.mjs"),
...
export {
  ...
  getCookie as l,
  getCookies as m,
  getRequestHeaders as n,
  getRequestIP as o,
  getRequestProtocol as p,
  getRequestUrl as q,
  getResponse as r,
