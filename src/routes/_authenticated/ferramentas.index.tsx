...
import { Wrench, Sparkles, Hammer, ArrowRight, Layers, FileSpreadsheet } from "lucide-react";
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        ...
        >
          ...
          <div className="relative">
            ...
            <p className="text-[13px] text-muted-foreground leading-relaxed">
              Consolida cobranças quitadas e emissões em uma planilha editável, com o resumo
              contratual e exportação em XLSX ou CSV.
            </p>
            <div className="mt-4 inline-flex items-center gap-1.5 text-[12px] text-primary font-medium">
              Abrir ferramenta
              <ArrowRight className="h-3.5 w-3.5 group-hover:translate-x-0.5 transition" />
